...
class DeleteStockFromWatchlist @Inject constructor(
    ...
    operator fun invoke(
        ...
        val result = safeApiCall { repository.deleteStockFromWatchlist(stock=stock, watchlistEntity=watchlistEntity) }
        emit(result)
    }
}